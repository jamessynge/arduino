 ...
 * 
 * Sequence:
 * 1) Start connecting to AP.
 * 2) Measure temperature, humidity and Vcc voltage.
 * 3) Wait until connected to AP.
 * 4) Report measurements.
 * 5) Enter deepSleep.
 *
 * Status: Waking from deep sleep every 5 minutes (not deepSleep(5minutes)),
 * it was able to make  228 reports over 18 hours and 9 minutes. Disappointing,
 * I expected a better result than sketch_dec15a_report_then_deep_sleep.ino
 * because it is doing the measurement at the same time as connecting to the AP.
 * 
 * Change Log:
