...
//  digitalWrite(2, HIGH);
  ...
  float compensated = humidity + (25.0 - temperature) * 0.15;
  Serial.print("Temp: "); Serial.print(temperature);
  Serial.print("\t\tRH(raw): "); Serial.print(humidity);
  Serial.print("\t\tRH(comp): "); Serial.println(compensated);
